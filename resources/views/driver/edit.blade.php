...
@section('content')
    <div class="row mt-4">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Update Driver</h6><br>
                    <form class="forms-sample" action="{{ route('driver.update', $user->id)}}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('put') }}
                        <div class="row">
...
{{--                            </div>--}}
                            <div class=" col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control"  placeholder="ven_number" name="ven_number" value="{{$user->ven_number}}" required>
                            </div>

                            <div class=" col-md-6 mb-3">
                                <label for="name" class="form-label">Licence Number<span class="text-danger">*</span></label>
                                <input type="text" class="form-control"  placeholder="licence number" name="licence_number"  value="{{$user->licence_number}}" required>
                            </div>
{{--                            <div class=" col-md-6 mb-3">--}}
{{--                                <label for="role" class="form-label">Role<span class="text-danger">*</span></label>--}}
{{--                                <input type="text" class="form-control"  placeholder="role" name="role" value="{{$user->role}}" required>--}}
{{--                            </div>--}}
                        </div>
{{--                        <div class=" col-md-6 mb-3">--}}
{{--                            <label for="image" class="form-label">Image<span class="text-danger">*</span></label>--}}
{{--                            <input type="file" class="form-control"  placeholder="image" name="image" value="{{$user->image}}">--}}
{{--                        </div>--}}
                        <div class="mt-2">
