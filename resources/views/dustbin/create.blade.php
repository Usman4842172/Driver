        ...
        <div class="col-md-12">
            <div class="card custom">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('dustbin.store')}}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('POST') }}
                        <div class="row">
                            <div class="col-6 mb-3">
                                <label for="dus_number" class="form-label">Dustbin Number<span class="text-danger">*</span></label>
                                <input type="text" class="form-control"  placeholder="dustbin number" name="dus_number"  required>
                            </div>
                            <div class="col-6 mb-3">
                                <label for="dus_address" class="form-label">Dustbin Address<span class="text-danger">*</span></label>
                                <input type="text" class="form-control"  placeholder="dus address" name="dus_address"  required>
                            </div>
                        </div>
                        <div class="mt-2">
